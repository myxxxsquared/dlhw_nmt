...
class DecoderLayer(tf.keras.layers.Layer):
    ...
    def call(self, x, enc_output, training, look_ahead_mask, padding_mask):
        ...
        # tf.print(attn_weights_block2[0], summarize=-1)
...
class Encoder(tf.keras.layers.Layer):
    def __init__(
        ...
        #     ),
        # )
        self.pos_encoding = self.add_weight(name="pos_encoding", trainable=True, shape=(1, maximum_position_encoding, self.d_model), dtype=tf.float32)
...
class Decoder(tf.keras.layers.Layer):
    def __init__(
        ...
        #     trainable=True,
        #     initial_value=tf.random.truncated_normal(
        #         dtype=tf.float32, shape=(1, maximum_position_encoding, self.d_model)
        #     ),
        # )
        self.pos_encoding = self.add_weight(name="pos_encoding", trainable=True, shape=(1, maximum_position_encoding, self.d_model), dtype=tf.float32)
